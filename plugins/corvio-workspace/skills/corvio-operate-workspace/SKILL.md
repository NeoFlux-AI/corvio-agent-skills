...
This is Corvio Skill release `1.7.75`.
It implements `coding_agent_collaboration` contract version `2026-09-18.1`, compatibility family `coding-agent-collaboration-v1`, and
